...
public:
	...
	void setInt_vector(const string& name, const vector<int> vec, const unsigned int size) const;
	
	void setFloat(const string& name, float value) const;
	void setFloat(int location, float value) const;
	void setFloat_vector(const string& name, const vector<float> vec, const unsigned int size) const;
	...
	void set2fv_vector(const string& name, const vector<glm::vec2> vec, const unsigned int size) const;
	...
	void set3fv_vector(const string& name, const vector<glm::vec3> vec, const unsigned int size) const;
	...
	void set4fv_vector(const string& name, const vector<glm::vec4> vec, const unsigned int size) const;
